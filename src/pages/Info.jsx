  ...
  return (
    <>
      <div className="flex justify-center items-center p-8   opacity-80  ">
        ...
        <div className="relative md:max-w-3xl ms:max-w-2xl ">
              ...
              <div className="space-y-0.5 relative z-10 py-2 px-2">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="w-full text-3xl font-serif text-[#5A4A3A] 
                              ...
                              italic"
                     style={{fontSize: 'clamp(1.2rem, 2.5vw, 1.8rem)'}}>Verba Sapientum ✍️   </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  >Verba Sapientum, "Palabras de sabiduría" en latín es una aplicación SPA (Single-Page Applications) desarrollada en React y que tiene como objetivo principal proporcionar citas motivacionales e inspiradoras que inviten a la reflexión, aprendizaje y en definitiva al desarrollo personal del usuario.</p>
                </div>
                ...
                <div className="flex flex-col items-center pt-4 border-t-2 border-[#8B6F47] border-opacity-20">
                  <p
                    ...
                    rows="3"
                  >@2026 Ignacio Palenque. Todos los derechos reservados</p>
                </div>
