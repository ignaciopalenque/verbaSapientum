...
export default function Cita({cita}) {
  const indiceAleatorio = Math.floor(Math.random() * cita?.citas?.length);
  return (
    <>
              ...
              <div className="space-y-0.5 relative z-10 py-2 px-2">
                ...
                <div className="flex flex-col items-center text-center">
                  <label className="text-xs uppercase tracking-widest text-[#8B6F47] font-semibold mb-2 opacity-70">
                    Cita Célebre Aleatoria
                  </label>
                  <input
                    type="text"
                    value={cita.citas[indiceAleatorio].titulo + ' 📜'} 
                    disabled
                ...
                <div className="flex flex-col items-center text-center">
                  <textarea
                    value={cita.citas[indiceAleatorio].cita}
                    disabled
                ...
                <div className="flex flex-col items-center">
                  ...
                  <input
                    type="text"
                    value={cita.citas[indiceAleatorio].autor}
                    disabled
                ...
                <div className="flex flex-col items-center pt-4 border-t-2 border-[#8B6F47] border-opacity-20">
                  <textarea
                    value={cita.citas[indiceAleatorio].descripcion}
                    disabled
